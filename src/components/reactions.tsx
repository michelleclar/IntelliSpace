...
export const Reactions = ({ data, onChange }: ReaactionsProps) => {
      ...
      {data.map((reaction) => (
        ...
        >
          <button
            ...
            className={cn(
              "h-6 px-2 rounded-full bg-slate-200/70 border border-transparent text-slate-800 flex items-center gaap-x-1",
